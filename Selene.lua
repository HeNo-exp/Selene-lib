...
a.AppRecorder = function()
    ...
    local d = __require'ElementsRegistry'
    local e = {}
    ...
    function e.Dump(f)
        ...
        for h, i in ipairs(d.elements)do
            if i.value ~= nil and i.name and i.tabTitle then
                g[i.tabTitle] = g[i.tabTitle] or {}
                ...
                elseif typeof(j) == 'EnumItem' then
                    j = {
                        Name = j.Name,
                        EnumType = tostring(j.EnumType),
                        _type = 'EnumItem',
                    }
                end

                g[i.tabTitle][i.name] = j
            end
        end

        local h, i = pcall(function()
            return c:JSONEncode(g)
        end)

        return h and i or '{}'
    end
    function e.Load(f, g)
        if not c or not g or g == '' then
            return
        end

        local h, i = pcall(function()
            return c:JSONDecode(g)
        end)
        ...
        local function deserializeValue(j)
            if type(j) == 'table' and j._type == 'Color3' then
                return Color3.new(j.R, j.G, j.B)
            elseif type(j) == 'table' and j._type == 'EnumItem' then
                local k = Enum[j.EnumType]

                if k and k[j.Name] then
                    return k[j.Name]
                end
            end
        ...
        for j, k in ipairs(d.elements)do
            local l = i[k.tabTitle]

            if l and k.name and l[k.name] ~= nil then
                local m = deserializeValue(l[k.name])
...
a['Components/Button'] = function()
    local c = __require'Theme'
    ...
    return function(e, f, g, h)
        ...
        i.Size = UDim2.new(1, 0, 0, 36)
        i.BackgroundColor3 = c.Colors.Element
        i.Text = ''
        ...
        j.CornerRadius = c.CornerRadius.Element
        j.Parent = i

        local k = Instance.new'UIStroke'

        k.Color = c.Colors.Border
        k.Thickness = 1
        k.Parent = i
        ...
        if f.Icon then
            ...
            n.Size = UDim2.fromOffset(16, 16)
            n.BackgroundTransparency = 1
            n.Image = f.Icon
            n.ImageColor3 = c.Colors.Text
            n.Parent = l
        end
        ...
        o.Text = f.Label or 'Button'
        o.TextColor3 = c.Colors.Text
        o.Font = c.Fonts.Bold
        o.TextSize = 13
        o.Parent = l

        i.MouseEnter:Connect(function()
            d:Create(i, TweenInfo.new(0.2), {
                BackgroundColor3 = c.Colors.ElementHover,
            }):Play()
            d:Create(k, TweenInfo.new(0.2), {
                Color = c.Colors.BorderHover,
            }):Play()
        end)
        i.MouseLeave:Connect(function()
            d:Create(i, TweenInfo.new(0.2), {
                BackgroundColor3 = c.Colors.Element,
            }):Play()
            d:Create(k, TweenInfo.new(0.2), {
        ...
        function p.SetText(q, r)
            o.Text = r
        end
        function p.SetIcon(q, r)
            if n then
                n.Image = r
            end
        end
        function p.SetCallback(q, r)
            f.Pushed = r
        end
...
a['Components/Charts'] = function()
    local c = __require'Theme'
    local d = {}

    function d.BarChart(e, f, g, h)
        f = f or {}

        local i = Instance.new'Frame'

        i.Size = UDim2.new(1, 0, 0, f.Height or 120)
        i.BackgroundColor3 = c.Colors.Element
        i.Parent = e

        local j = Instance.new'UICorner'

        j.CornerRadius = c.CornerRadius.Card
        j.Parent = i
        ...
        local function rebuildChart()
            ...
            for q, r in ipairs(n)do
                local s = p > 0 and (1 / p) or 0.1
                local t = Instance.new'Frame'

                t.Size = UDim2.new(s, -8, r / o, 0)
                t.BackgroundColor3 = c.Colors.Accent
                t.Parent = l
        ...
        function o.SetData(p, q)
            n = q or {}

            rebuildChart()
        end
        function o.PushData(p, q, r)
            table.insert(n, q)
        ...
        function o.SetTitle(p, q) end
        function o.SetSubtitle(p, q) end

        return o
    end
    function d.LineChart(...)
        return d.BarChart(...)
    end
    function d.PieChart(...)
        return d.BarChart(...)
...
a['Components/ColorPicker'] = function()
    local c = __require'Theme'
    local d = game:GetService'TweenService'
    local e = game:GetService'UserInputService'
    local f = __require'ElementsRegistry'
    ...
    return function(g, h, i, j)
        ...
        l.BackgroundTransparency = 1
        l.Text = h.Title or 'Color Picker'
        l.TextColor3 = c.Colors.Text
        l.Font = c.Fonts.Medium
        l.TextSize = 13
        ...
        m.Position = UDim2.new(1, -150, 0, 0)
        ...
        r.Color = c.Colors.Border
        r.Thickness = 1.5
        r.Parent = p

        local s = h.Value or Color3.fromRGB(255, 255, 255)
        local t = h.Transparency or 0

        local function updateVisuals()
            local u = math.round(s.R * 255)
            local v = math.round(s.G * 255)
            local w = math.round(s.B * 255)
            local x = math.round((1 - t) * 100)

            o.Text = string.format('#%02X%02X%02X (%d%%)', u, v, w, x)
            p.BackgroundColor3 = s
            p.BackgroundTransparency = t
        end

        updateVisuals()
        p.MouseEnter:Connect(function()
            d:Create(r, TweenInfo.new(0.2), {
                Color = c.Colors.BorderHover,
            }):Play()
        end)
        ...
        p.MouseButton1Click:Connect(function()
            local u = g:FindFirstAncestorOfClass'ScreenGui'
            ...
            pcall(function()
                local v = u:FindFirstChild'SeleneRoot' or u
                local w = v:FindFirstChild'ColorPickerOverlay'
                ...
                z.Size = UDim2.fromOffset(320, 260)
                z.Position = UDim2.new(0.5, -160, 0.5, -130)
                z.BackgroundColor3 = c.Colors.Card
                z.Parent = x

                local A = Instance.new'UICorner'

                A.CornerRadius = c.CornerRadius.Card
                A.Parent = z

                local B = Instance.new'UIStroke'

                B.Color = c.Colors.Border
                B.Thickness = 1
                B.Parent = z
                ...
                D.Text = h.Title or 'Select Color'
                D.TextColor3 = c.Colors.Text
                D.Font = c.Fonts.Bold
                D.TextSize = 13
                ...
                E.Size = UDim2.new(1, -24, 0, 40)
                E.BackgroundColor3 = s
                E.Parent = z

                local F = Instance.new'UICorner'

                F.CornerRadius = c.CornerRadius.Element
                F.Parent = E

                local G = Instance.new'Frame'

                G.Size = UDim2.new(1, -24, 0, 80)
                ...
                local function makeColorSlider(I, J, K, L)
                    local M = Instance.new'Frame'
                    ...
                    N.Size = UDim2.new(0, 40, 1, 0)
                    N.BackgroundTransparency = 1
                    N.Text = I
                    N.TextColor3 = c.Colors.TextSecondary
                    N.Font = c.Fonts.Medium
                    N.TextSize = 11
                    ...
                    O.Size = UDim2.new(1, -50, 0, 6)
                    O.Position = UDim2.new(0, 50, 0.5, -3)
                    O.BackgroundColor3 = c.Colors.Element
                    O.Text = ''
                    ...
                    P.BackgroundColor3 = c.Colors.Accent
                    P.BorderSizePixel = 0
                    P.Parent = O
                    ...
                    O.InputBegan:Connect(function(S)
                        if S.UserInputType == Enum.UserInputType.MouseButton1 or S.UserInputType == Enum.UserInputType.Touch then
                            ...
                            local T = math.clamp((S.Position.X - O.AbsolutePosition.X) / O.AbsoluteSize.X, 0, 1)
                    ...
                    e.InputChanged:Connect(function(S)
                        if R and (S.UserInputType == Enum.UserInputType.MouseMovement or S.UserInputType == Enum.UserInputType.Touch) then
                            local T = math.clamp((S.Position.X - O.AbsolutePosition.X) / O.AbsoluteSize.X, 0, 1)
                ...
                makeColorSlider('Red', s.R, 1, function(I)
                    s = Color3.new(I, s.G, s.B)
                end)
                makeColorSlider('Green', s.G, 1, function(I)
                    s = Color3.new(s.R, I, s.B)
                end)
                makeColorSlider('Blue', s.B, 1, function(I)
                    s = Color3.new(s.R, s.G, I)
                end)

                local I = Instance.new'Frame'

                I.Size = UDim2.new(1, -24, 0, 30)
                I.BackgroundTransparency = 1
                I.Parent = z

                local J = Instance.new'TextButton'

                J.Size = UDim2.new(0, 80, 1, 0)
                J.Position = UDim2.new(1, -80, 0, 0)
                J.BackgroundColor3 = c.Colors.Accent
                J.Text = 'Apply'
                ...
                K.CornerRadius = c.CornerRadius.Element
                K.Parent = J

                J.MouseButton1Click:Connect(function()
                    updateVisuals()

                    if h.ValueChanged then
                        task.spawn(function()
                            pcall(h.ValueChanged, s, t)
                        end)
                    end
        ...
        local u = {
            name = h.Title or 'Color Picker',
            tabTitle = i,
        }

        function u.SetValue(v, w, x)
            s = w or Color3.fromRGB(255, 255, 255)
            t = x or 0

            updateVisuals()
        end
        function u.SetText(v, w)
            l.Text = w
            v.name = w
        end
        function u.SetCallback(v, w)
            h.ValueChanged = w
        end

        setmetatable(u, {
            __index = function(v, w)
                if w == 'value' then
                    return s
                end
            ...
            __newindex = function(v, w, x)
                if w == 'value' then
                    s = x or Color3.fromRGB(255, 255, 255)
        ...
        table.insert(f.elements, u)

        return u
    end
end
a['Components/ColorPickerWidget'] = function()
    return __require'Components/ColorPicker'
end
a['Components/Dropdown'] = function()
    local c = __require'Theme'
    local d = __require'ElementsRegistry'
    ...
    return function(e, f, g, h)
        ...
        local i = f.Options or {}
        local j = f.Maximum and f.Maximum > 1 or (type(f.Value) == 'table')
        local k = f.Maximum or (j and 9999 or 1)
        local l = f.Value or (j and {} or 1)
        local m = Instance.new'Frame'
        ...
        p.CornerRadius = c.CornerRadius.Element
        p.Parent = o

        local q = Instance.new'UIStroke'

        q.Color = c.Colors.Border
        q.Thickness = 1
        q.Parent = o
        ...
        r.Text = f.Label or 'Dropdown'
        r.TextColor3 = c.Colors.TextSecondary
        r.Font = c.Fonts.Medium
        r.TextSize = 13
        ...
        s.Size = UDim2.new(0.5, -30, 1, 0)
        s.Position = UDim2.new(1, -30, 0, 0)
        ...
        t.Position = UDim2.new(1, -22, 0.5, -7)
        t.BackgroundTransparency = 1
        t.Image = 'rbxassetid://10747383844'
        t.ImageColor3 = c.Colors.TextSecondary
        t.Parent = o
        ...
        w.PaddingTop = UDim.new(0, 4)
        w.PaddingBottom = UDim.new(0, 4)
        w.Parent = u
        ...
        local function getHeaderText()
            if j then
                ...
                return tostring(i[l] or 'Select...')
            end
        end
        local function updateVisuals()
            s.Text = getHeaderText()

            for z, A in ipairs(y)do
                local B = false

                if j then
                    B = table.find(l, z) ~= nil
                else
                    B = z == l
                end

                A.BackgroundColor3 = (not j and B) and c.Colors.Accent or c.Colors.Element

                local C = A:FindFirstChildOfClass'Frame':FindFirstChildOfClass'TextLabel'

                if C then
                    C.TextColor3 = (not j and B) and Color3.fromRGB(255, 255, 255) or c.Colors.Text
                    C.Font = B and c.Fonts.Bold or c.Fonts.Regular
                end

                local D = A:FindFirstChildOfClass'Frame':FindFirstChild'Checkbox'

                if D then
                    D.BackgroundColor3 = B and c.Colors.Accent or c.Colors.Element

                    local E = D:FindFirstChild'Inner'
        ...
        local function rebuildOptions()
            ...
            for z, A in ipairs(i)do
                local B = Instance.new'TextButton'

                B.Size = UDim2.new(1, 0, 0, 28)
                B.BackgroundColor3 = c.Colors.Element
                B.Text = ''
                ...
                C.CornerRadius = c.CornerRadius.Element
                C.Parent = B
                ...
                if j then
                    ...
                    J.Name = 'Inner'
                    J.Size = UDim2.fromOffset(6, 6)
                    J.Position = UDim2.new(0.5, -3, 0.5, -3)
                    J.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    J.Parent = G

                    local K = Instance.new'UICorner'

                    K.CornerRadius = UDim.new(0, 1)
                    K.Parent = J
                end

                local H = Instance.new'TextLabel'

                H.Size = UDim2.new(1, j and -26 or -16, 1, 0)
                ...
                B.MouseButton1Click:Connect(function()
                    ...
                    if f.ValueChanged then
                        task.spawn(function()
                            pcall(f.ValueChanged, l)
                        end)
                    end
                end)
                table.insert(y, B)
        ...
        local z = {
            name = f.Label or 'Dropdown',
            tabTitle = g,
        }

        function z.SetValue(A, B)
            l = B

            updateVisuals()
        end
        function z.SetOptions(A, B)
            i = B or {}

            rebuildOptions()
        end
        function z.SetText(A, B)
            r.Text = B
            A.name = B
        end
        function z.SetCallback(A, B)
            f.ValueChanged = B
        end
        ...
        table.insert(d.elements, z)

        return z
    end
end
a['Components/HStack'] = function()
    return function(c, d, e, f)
        ...
        h.Padding = UDim.new(0, d.Padding or 6)

        if d.HorizontalAlignment then
            h.HorizontalAlignment = d.HorizontalAlignment
        end
        if d.VerticalAlignment then
            h.VerticalAlignment = d.VerticalAlignment
        end
...
a['Components/ImageSurface'] = function()
    return function(c, d, e, f)
        d = d or {}

        local g = Instance.new'ImageLabel'

        g.Size = UDim2.new(1, 0, 0, 120)
        g.BackgroundTransparency = 1
        g.Image = d.Image or ''
        g.ImageColor3 = d.SurfaceColor or Color3.fromRGB(255, 255, 255)
        g.Parent = c

        local h = {__instance = g}

        return h
    end
end
a['Components/InfoGrid'] = function()
    local c = __require'Theme'
    ...
    return function(d, e, f, g)
        ...
        local function rebuildGrid()
            for l, m in ipairs(h:GetChildren())do
            ...
            for l, m in ipairs(j)do
                ...
                for q, r in ipairs(m)do
                    local s = r.weight or 1
                    local t = s / p
                    local u = Instance.new'Frame'

                    u.Size = UDim2.new(t, -8, 0, 48)
                    u.BackgroundColor3 = c.Colors.Element
                    u.Parent = n

                    local v = Instance.new'UICorner'

                    v.CornerRadius = c.CornerRadius.Element
                    v.Parent = u

                    local w = Instance.new'UIStroke'

                    w.Color = c.Colors.Border
                    w.Thickness = 1
                    w.Parent = u
                    ...
                    x.Padding = UDim.new(0, 2)
                    x.VerticalAlignment = Enum.VerticalAlignment.Center
                    x.Parent = u

                    local y = Instance.new'UIPadding'

                    y.PaddingLeft = UDim.new(0, 10)
                    y.Parent = u

                    local z = Instance.new'TextLabel'

                    z.Size = UDim2.new(1, 0, 0, 14)
                    z.BackgroundTransparency = 1
                    z.Text = r.title or ''
                    z.TextColor3 = c.Colors.TextSecondary
                    z.Font = c.Fonts.Medium
                    z.TextSize = 10
...
a['Components/KeybindField'] = function()
    local c = __require'Theme'
    local d = game:GetService'TweenService'
    local e = game:GetService'UserInputService'
    local f = __require'ElementsRegistry'
    ...
    return function(g, h, i, j)
        ...
        local k = h.Value or Enum.KeyCode.None
        local l = Instance.new'Frame'
        ...
        m.Size = UDim2.new(1, -120, 1, 0)
        m.BackgroundTransparency = 1
        m.Text = h.Label or 'Keybind'
        m.TextColor3 = c.Colors.Text
        m.Font = c.Fonts.Medium
        m.TextSize = 13
        ...
        n.Size = UDim2.fromOffset(100, 26)
        n.Position = UDim2.new(1, -100, 0.5, -13)
        n.BackgroundColor3 = c.Colors.Element
        n.Text = k == Enum.KeyCode.None and 'None' or k.Name
        n.TextColor3 = c.Colors.Text
        n.Font = c.Fonts.Bold
        n.TextSize = 11
        ...
        o.CornerRadius = c.CornerRadius.Element
        o.Parent = n

        local p = Instance.new'UIStroke'

        p.Color = c.Colors.Border
        p.Thickness = 1
        p.Parent = n
        ...
        local function updateVisuals()
            n.Text = q and 'Press any key...' or (k == Enum.KeyCode.None and 'None' or k.Name)
            n.TextColor3 = q and c.Colors.Accent or c.Colors.Text
        end

        n.MouseEnter:Connect(function()
            d:Create(p, TweenInfo.new(0.2), {
                Color = c.Colors.BorderHover,
            }):Play()
        end)
        ...
        n.MouseButton1Click:Connect(function()
            ...
            r = e.InputBegan:Connect(function(s, t)
                if t then
                    return
                end
        ...
        local r = {
            name = h.Label or 'Keybind',
            tabTitle = i,
        }

        function r.SetValue(s, t)
            k = t

            updateVisuals()
        end
        function r.SetText(s, t)
            m.Text = t
            s.name = t
        end
        function r.SetCallback(s, t)
            h.ValueChanged = t
        end
        ...
        table.insert(f.elements, r)

        return r
    end
end
a['Components/Label'] = function()
    local c = __require'Theme'
    ...
    return function(d, e, f, g)
        ...
        h.BackgroundTransparency = 1
        h.Text = e.Text or 'Label'
        h.TextColor3 = e.TextColor3 or c.Colors.Text
        h.Font = e.Font or c.Fonts.Regular
        h.TextSize = e.TextSize or 12
        h.TextXAlignment = e.TextXAlignment or Enum.TextXAlignment.Left
        h.Parent = d

        local i = {}

        function i.SetText(j, k)
            h.Text = k
        end
...
a['Components/Paragraph'] = function()
    local c = __require'Theme'
    ...
    return function(d, e, f, g)
        ...
        j.Size = UDim2.new(1, 0, 0, 18)
        j.BackgroundTransparency = 1
        j.Text = e.Title or 'Paragraph'
        j.TextColor3 = c.Colors.Text
        j.Font = c.Fonts.Bold
        j.TextSize = 13
        ...
        k.BackgroundTransparency = 1
        k.Text = e.Content or ''
        k.TextColor3 = c.Colors.TextSecondary
        k.Font = c.Fonts.Regular
        k.TextSize = 11
        k.TextWrapped = true
        ...
        function l.SetTitle(m, n)
            j.Text = n
        end
        function l.SetContent(m, n)
            k.Text = n
        end
...
a['Components/PullDownButton'] = function()
    local c = __require'Theme'

    return function(d, e, f, g)
        e = e or {}

        local h = e.Options or {}
        local i = Instance.new'Frame'
        ...
        k.Size = UDim2.new(1, 0, 0, 36)
        k.BackgroundColor3 = c.Colors.Element
        k.Text = ''
        ...
        l.CornerRadius = c.CornerRadius.Element
        l.Parent = k

        local m = Instance.new'UIStroke'

        m.Color = c.Colors.Border
        m.Thickness = 1
        m.Parent = k
        ...
        o.Size = UDim2.fromOffset(14, 14)
        o.Position = UDim2.new(1, -22, 0.5, -7)
        o.BackgroundTransparency = 1
        o.Image = 'rbxassetid://10747383844'
        o.ImageColor3 = c.Colors.TextSecondary
        o.Parent = k
        ...
        local function rebuildOptions()
            ...
            for t, u in ipairs(h)do
                ...
                v.BackgroundColor3 = c.Colors.Element
                v.Text = ''
                ...
                w.CornerRadius = c.CornerRadius.Element
                w.Parent = v

                local x = Instance.new'TextLabel'

                x.Size = UDim2.new(1, -16, 1, 0)
                x.Position = UDim2.new(0, 8, 0, 0)
                x.BackgroundTransparency = 1
                x.Text = tostring(u)
                x.TextColor3 = c.Colors.Text
                x.Font = c.Fonts.Regular
        ...
        function t.SetOptions(u, v)
            h = v or {}

            rebuildOptions()
        end
        function t.SetText(u, v)
            n.Text = v
        end
        function t.SetCallback(u, v)
            e.ValueChanged = v
        end
...
a['Components/RadioButtonGroup'] = function()
    local c = __require'Theme'
    local d = __require'ElementsRegistry'
    ...
    return function(e, f, g, h)
        ...
        local function updateVisuals()
            for q, r in ipairs(p)do
                local s = (q == j)
                local t = r:FindFirstChild'RadioCircle'

                if t then
                    t.BackgroundColor3 = s and c.Colors.Accent or c.Colors.Element

                    local u = t:FindFirstChild'Fill'
                ...
                local u = r:FindFirstChild'OptionLabel'

                if u then
                    u.TextColor3 = s and c.Colors.Text or c.Colors.TextSecondary
                    u.Font = s and c.Fonts.Bold or c.Fonts.Medium
                end
            end
        end
        ...
        for q, r in ipairs(i)do
            ...
            v.CornerRadius = c.CornerRadius.Circle
            v.Parent = u
            ...
            x.Name = 'Fill'
            x.Size = UDim2.fromOffset(6, 6)
            x.Position = UDim2.new(0.5, -3, 0.5, -3)
            x.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            x.Parent = u

            local y = Instance.new'UICorner'

            y.CornerRadius = c.CornerRadius.Circle
            y.Parent = x

            local z = Instance.new'TextLabel'

            z.Name = 'OptionLabel'
            z.Size = UDim2.new(1, -24, 1, 0)
            z.BackgroundTransparency = 1
            z.Text = tostring(r)
            z.TextXAlignment = Enum.TextXAlignment.Left
            z.TextSize = 12
        ...
        local q = {
            name = f.Label or 'RadioGroup',
            tabTitle = g,
        }

        function q.SetValue(r, s)
            j = math.clamp(s, 1, #i)

            updateVisuals()
        end
        function q.SetText(r, s)
            if m then
                m.Text = s
            end
        ...
        table.insert(d.elements, q)

        return q
    end
end
a['Components/Row'] = function()
    return function(c, d, e, f)
        d = d or {}
        ...
        j.FillDirection = Enum.FillDirection.Vertical
        j.Padding = UDim.new(0, 6)
        j.Parent = i

        local k = Instance.new'Frame'

        k.Size = UDim2.new(0.5, -6, 0, 0)
        k.AutomaticSize = Enum.AutomaticSize.Y
        k.BackgroundTransparency = 1
        k.Parent = g
...
a['Components/Slider'] = function()
    ...
    return function(g, h, i, j)
        ...
        local k = h.Minimum or 0
        local l = h.Maximum or 100
        local m = h.Value or k
        local n = Instance.new'Frame'
        ...
        p.Size = UDim2.new(1, -60, 1, 0)
        p.BackgroundTransparency = 1
        p.Text = h.Label or 'Slider'
        p.TextColor3 = c.Colors.Text
        p.Font = c.Fonts.Medium
        p.TextSize = 13
        ...
        q.Size = UDim2.new(0, 50, 1, 0)
        q.Position = UDim2.new(1, -50, 0, 0)
        q.BackgroundTransparency = 1
        q.Text = tostring(m)
        q.TextColor3 = c.Colors.TextSecondary
        q.Font = c.Fonts.Bold
        q.TextSize = 12
        ...
        s.Position = UDim2.new(0, 0, 0.5, -4)
        s.BackgroundColor3 = c.Colors.Element
        s.Text = ''
        s.AutoButtonColor = false
        s.Parent = r
        ...
        t.CornerRadius = c.CornerRadius.Circle
        t.Parent = s

        local u = Instance.new'UIStroke'

        u.Color = c.Colors.Border
        u.Thickness = 1
        u.Parent = s

        local v = Instance.new'Frame'

        v.BackgroundColor3 = c.Colors.Accent
        v.BorderSizePixel = 0
        v.Parent = s

        local w = Instance.new'UICorner'

        w.CornerRadius = c.CornerRadius.Circle
        w.Parent = v
        ...
        local function updateVisuals()
            local B = math.clamp((m - k) / (l - k), 0, 1)

            v.Size = UDim2.new(B, 0, 1, 0)
            x.Position = UDim2.new(B, -6, 0.5, -6)
            q.Text = tostring(m)
        end
        local function inputHandler(B)
            local C = s.AbsoluteSize.X
            local D = s.AbsolutePosition.X
            local E = B.Position.X
            local F = math.clamp((E - D) / C, 0, 1)

            m = math.round(k + (F * (l - k)))

            updateVisuals()

            if h.ValueChanged then
                task.spawn(function()
                    pcall(h.ValueChanged, m)
                end)
            end
        end

        s.MouseEnter:Connect(function()
            d:Create(u, TweenInfo.new(0.2), {
                Color = c.Colors.BorderHover,
            }):Play()
        end)
        ...
        s.InputBegan:Connect(function(B)
        ...
        e.InputChanged:Connect(function(B)
            if A and (B.UserInputType == Enum.UserInputType.MouseMovement or B.UserInputType == Enum.UserInputType.Touch) then
                inputHandler(B)
            end
        end)
        e.InputEnded:Connect(function(B)
            if B.UserInputType == Enum.UserInputType.MouseButton1 or B.UserInputType == Enum.UserInputType.Touch then
                A = false
            end
        end)
        ...
        function B.SetMin(C, D)
            k = D

            updateVisuals()
        end
        function B.SetMax(C, D)
            l = D
        ...
        updateVisuals()
        table.insert(f.elements, B)

        return B
    end
end
a['Components/Stepper'] = function()
    local c = __require'Theme'
    local d = __require'ElementsRegistry'
    ...
    return function(e, f, g, h)
        ...
        local i = f.Minimum or 0
        local j = f.Maximum or 100
        local k = f.Step or 1
        local l = f.Value or i
        local m = Instance.new'Frame'
        ...
        n.Size = UDim2.new(1, -130, 1, 0)
        n.BackgroundTransparency = 1
        n.Text = f.Label or 'Stepper'
        n.TextColor3 = c.Colors.Text
        n.Font = c.Fonts.Medium
        n.TextSize = 13
        n.TextXAlignment = Enum.TextXAlignment.Left
        ...
        o.Size = UDim2.fromOffset(120, 26)
        o.Position = UDim2.new(1, -120, 0.5, -13)
        o.BackgroundTransparency = 1
        o.Parent = m
        ...
        t.CornerRadius = c.CornerRadius.Element
        t.Parent = s
        ...
        u.Size = UDim2.fromOffset(26, 26)
        u.BackgroundColor3 = c.Colors.Element
        u.Text = '+'
        u.TextColor3 = c.Colors.Text
        u.Font = c.Fonts.Bold
        u.TextSize = 14
        ...
        local w = {
            name = f.Label or 'Stepper',
            tabTitle = g,
        }

        function w.SetValue(x, y)
            update(y)
        end
        function w.SetText(x, y)
            n.Text = y
            x.name = y
        end
        function w.SetCallback(x, y)
            f.ValueChanged = y
        end
        ...
        table.insert(d.elements, w)

        return w
    end
end
a['Components/TextBox'] = function()
    local c = __require'Theme'
    local d = game:GetService'TweenService'
    local e = __require'ElementsRegistry'
    ...
    return function(f, g, h, i)
        ...
        j.Size = UDim2.new(1, 0, 0, 36)
        j.BackgroundTransparency = 1
        j.Parent = f

        local k = Instance.new'TextLabel'

        k.Size = UDim2.new(0, 150, 1, 0)
        k.BackgroundTransparency = 1
        k.Text = g.Label or 'Input'
        k.TextColor3 = c.Colors.Text
        k.Font = c.Fonts.Medium
        k.TextSize = 13
        k.TextXAlignment = Enum.TextXAlignment.Left
        k.Parent = j
        ...
        l.Size = UDim2.new(1, -160, 0, 28)
        l.Position = UDim2.new(1, -160, 0.5, -14)
        l.BackgroundColor3 = c.Colors.Element
        l.Parent = j

        local m = Instance.new'UICorner'

        m.CornerRadius = c.CornerRadius.Element
        m.Parent = l

        local n = Instance.new'UIStroke'

        n.Color = c.Colors.Border
        n.Thickness = 1
        n.Parent = l
        ...
        o.Position = UDim2.new(0, 8, 0, 0)
        o.BackgroundTransparency = 1
        o.Text = g.Value or ''
        o.PlaceholderText = g.Placeholder or 'Type here...'
        o.PlaceholderColor3 = c.Colors.TextSecondary
        o.TextColor3 = c.Colors.Text
        o.Font = c.Fonts.Regular
        o.TextSize = 12
        o.TextXAlignment = Enum.TextXAlignment.Left
        o.ClearTextOnFocus = false
        o.Parent = l

        o.FocusLost:Connect(function(p)
            local q = o.Text

            if g.ValueChanged then
                task.spawn(function()
                    pcall(g.ValueChanged, q, p)
                end)
            end
        end)
        o.MouseEnter:Connect(function()
            d:Create(n, TweenInfo.new(0.2), {
                Color = c.Colors.BorderHover,
            }):Play()
        end)
        ...
        local p = {
            name = g.Label or 'Input',
            tabTitle = h,
            __instance = o,
        }

        function p.SetValue(q, r)
            o.Text = tostring(r)
        end
        function p.SetText(q, r)
            k.Text = r
...
a['Components/TitleStack'] = function()
    local c = __require'Theme'
...
a['Components/Toggle'] = function()
    ...
    return function(f, g, h, i)
        ...
        k.Size = UDim2.new(1, -60, 1, 0)
        k.BackgroundTransparency = 1
        k.Text = g.Label or 'Toggle'
        k.TextColor3 = c.Colors.Text
        k.Font = c.Fonts.Medium
        k.TextSize = 13
        k.TextXAlignment = Enum.TextXAlignment.Left
        ...
        l.Size = UDim2.new(0, 42, 0, 22)
        l.Position = UDim2.new(1, -42, 0.5, -11)
        l.BackgroundColor3 = g.Value and c.Colors.Accent or c.Colors.Element
        l.Text = ''
        ...
        m.CornerRadius = c.CornerRadius.Circle
        m.Parent = l
        ...
        o.Position = g.Value and UDim2.new(1, -19, 0.5, -8) or UDim2.new(0, 3, 0.5, 
-8)
        ...
        p.CornerRadius = c.CornerRadius.Circle
        p.Parent = o

        local q = g.Value or false

        local function updateVisuals()
            local r = q and c.Colors.Accent or c.Colors.Element
            local s = q and UDim2.new(1, -19, 0.5, -8) or UDim2.new(0, 3, 0.5, -8)

            d:Create(l, TweenInfo.new(0.2), {BackgroundColor3 = r}):Play()
            d:Create(o, TweenInfo.new(0.2), {Position = s}):Play()
        end
        ...
        l.MouseButton1Click:Connect(function()
            ...
            if g.ValueChanged then
                task.spawn(function()
                    pcall(g.ValueChanged, q)
                end)
            end
        end)

        local r = {
            name = g.Label or 'Toggle',
            tabTitle = h,
        }
        ...
        table.insert(e.elements, r)

        return r
    end
end
a['Components/VStack'] = function()
    return function(c, d, e, f)
        d = d or {}
...
a.init = function()
    ...
    local e = __require'Theme'
    local f = __require'AppRecorder'
    local g = __require'ElementsRegistry'
    local h = {}

    h.Theme = e
    h.Themes = e.Themes
    h.Accents = e.Accents
    h.Icons = __require'Icons'
    h._customComponents = {}
    h.elements = g.elements

    local i = h.Icons.assets

    local function toKebabCase(j)
        local k = j:gsub('(%u)', '-%1'):gsub('(%d+)', '-%1'):lower()
    ...
    setmetatable(j, {
        __index = function(k, l)
            ...
            if l == 'gear' or l == 'settings' then
                return i['lucide-settings']
            elseif l == 'house' or l == 'home' then
                return i['lucide-home']
            elseif l == 'checkmark' or l == 'check' then
            ...
            return function(l)
                ...
                for n, o in pairs(l)do
                    if type(n) == 'string' then
                        ...
                        if type(o) == 'table' and o.__instance then
                            p = o.__instance
                        end
                        if n ~= 'Parent' then
                            pcall(function()
                    ...
                    elseif typeof(o) == 'Instance' then
                        o.Parent = m
                    elseif type(o) == 'table' and o.__instance then
                        o.__instance.Parent = m
                    end
                end
                ...
                if l.Parent then
                    ...
                    if type(n) == 'table' and n.__instance then
                        n = n.__instance
                    end
                ...
                local n = {__instance = m}

                setmetatable(n, {
                    __index = function(o, p)
                        if p == '__instance' then
                            return m
                        else
                            local q = m[p]
                    ...
                    __newindex = function(o, p, q)
                        local r = q

                        if type(q) == 'table' and q.__instance then
                            r = q.__instance
                        end
    ...
    function h.RegisterComponent(k, l)
        h._customComponents[k] = l
    end
    ...
    local function getGuiParent()
        ...
        local r = q.LocalPlayer

        if r then
            local s = r:FindFirstChild'PlayerGui' or r:WaitForChild('PlayerGui', 5)
    ...
    local o = {
        Row = __require'Components/Row',
        TitleStack = __require'Components/TitleStack',
        Label = __require'Components/Label',
        Paragraph = __require'Components/Paragraph',
        Button = __require'Components/Button',
        Toggle = __require'Components/Toggle',
        Slider = __require'Components/Slider',
        TextField = __require'Components/TextBox',
        KeybindField = __require'Components/KeybindField',
        ColorPicker = __require'Components/ColorPicker',
        ColorPickerWidget = __require'Components/ColorPickerWidget',
        Stepper = __require'Components/Stepper',
        RadioButtonGroup = __require'Components/RadioButtonGroup',
        PopUpButton = __require'Components/Dropdown',
        PullDownButton = __require'Components/PullDownButton',
        VStack = __require'Components/VStack',
        HStack = __require'Components/HStack',
        BarChart = __require'Components/Charts'.BarChart,
        LineChart = __require'Components/Charts'.LineChart,
        PieChart = __require'Components/Charts'.PieChart,
        InfoGrid = __require'Components/InfoGrid',
        ImageSurface = __require'Components/ImageSurface',
    }

    local function setupContainerMethods(p, q, r)
        setmetatable(p, {
            __index = function(s, t)
                if h._customComponents[t] then
                    return function(u, v)
                        v = v or {}
                        v.Parent = q

                        local w = h._customComponents[t](u, v)
                        local x = (type(w) == 'table' and w.__instance) and w.__instance or w

                        if x and x.Parent ~= q then
                            x.Parent = q
                        end
        ...
        for s, t in pairs(o)do
            p[s] = function(u, v)
                return t(q, v, r, setupContainerMethods)
            end
        end
    end
    ...
    function h.New(p)
        ...
        if p.Theme then
            for s, t in pairs(e.Themes)do
                if t == p.Theme or s == p.Theme then
                    q = s
        ...
        if p.Accent then
            for s, t in pairs(e.Accents)do
                if t == p.Accent or s == p.Accent then
                    r = s
        ...
        e.Colors.Accent = e.Accents[r] or e.Accents.Blue
        ...
        local t = setmetatable({
            ...
            __index = function(t, u)
                if u == 'Theme' then
                    return e.Themes[q]
                elseif u == 'Accent' then
                    return e.Colors.Accent
                elseif u == 'Notification' then
                    return function(v, w)
                        h:Notification(w)
                    end
                elseif u == 'Page' then
                ...
                elseif u == 'Window' then
                    return function(v, w)
                        return h:CreateWindow(w)
                    end
                end
    ...
    function h.CreateWindow(p, q)
        q = q or {}

        local r = getGuiParent()
        ...
        t.Name = 'Window'
        t.Size = UDim2.fromOffset(750, 480)
        t.Position = UDim2.new(0.5, -375, 0.5, -240)
        t.BackgroundColor3 = e.Colors.Background
        t.Parent = s

        local u = Instance.new'UICorner'

        u.CornerRadius = e.CornerRadius.Window
        u.Parent = t

        local v = Instance.new'UIStroke'

        v.Color = e.Colors.Border
        v.Thickness = 1
        v.Parent = t
        ...
        x.Position = UDim2.new(0, 15, 0.5, -10)
        x.BackgroundTransparency = 1
        x.Image = 'rbxassetid://10734950309'
        x.ImageColor3 = e.Colors.Accent
        x.Parent = w

        local y = Instance.new'Frame'

        y.Size = UDim2.new(1, -310, 1, 0)
        ...
        A.BackgroundTransparency = 1
        A.Text = q.Title or q.Name or 'Selene UI'
        A.TextColor3 = e.Colors.Text
        A.Font = e.Fonts.Bold
        A.TextSize = 14
        A.Parent = y
        ...
        if q.TitleTag then
            ...
            B.BackgroundColor3 = e.Colors.Accent
            B.BorderSizePixel = 0
            B.Parent = y
            ...
            E.Text = string.upper(q.TitleTag)
            E.TextColor3 = Color3.fromRGB(255, 255, 255)
            E.Font = e.Fonts.Bold
            E.TextSize = 8
            E.Parent = B

            if type(q.TitleTagColor) == 'table' then
                local F = Instance.new'UIGradient'

                F.Color = ColorSequence.new(unpack(q.TitleTagColor))
                F.Rotation = 45
                F.Parent = B
            end
        end
        if q.Subtitle and q.Subtitle ~= '' then
            ...
            B.Text = q.Subtitle
            B.TextColor3 = e.Colors.TextSecondary
            B.Font = e.Fonts.Medium
            B.TextSize = 11
            B.Parent = y
        end
        if q.Draggable ~= false then
            local B = false
            local C, D, E

            w.InputBegan:Connect(function(F)
            ...
            w.InputChanged:Connect(function(F)
            ...
            d.InputChanged:Connect(function(F)
                if F == C and B then
                    ...
                    t.Position = UDim2.new(E.X.Scale, E.X.Offset + G.X, E.Y.Scale, E.Y.Offset + G.Y)
                end
            end)
        end
        ...
        B.Position = UDim2.new(1, -115, 0, 0)
        B.BackgroundTransparency = 1
        B.Parent = w
        ...
        E.Name = 'Container'
        E.Size = UDim2.new(1, 0, 1, -45)
        E.Position = UDim2.new(0, 0, 0, 45)
        E.BackgroundTransparency = 1
        E.Parent = t
        ...
        if q.CanMinimize ~= false then
            local G = Instance.new'ImageButton'

            G.Size = UDim2.fromOffset(14, 14)
            G.BackgroundTransparency = 1
            G.Image = 'rbxassetid://10747372251'
            G.ImageColor3 = e.Colors.TextSecondary
            G.Parent = B

            G.MouseButton1Click:Connect(function()
                D = not D

                local H = D and UDim2.fromOffset(750, 45) or UDim2.fromOffset(750, 480)

                c:Create(t, TweenInfo.new(0.25), {Size = H}):Play()

                E.Visible = not D
            end)
        end
        if q.CanExit ~= false then
            local G = Instance.new'ImageButton'

            G.Size = UDim2.fromOffset(14, 14)
            G.BackgroundTransparency = 1
            G.Image = 'rbxassetid://10747384394'
            G.ImageColor3 = e.Colors.TextSecondary
            G.Parent = B
        ...
        G.Name = 'Sidebar'
        G.Size = UDim2.new(0, 180, 1, 0)
        G.BackgroundColor3 = e.Colors.Sidebar
        G.BorderSizePixel = 0
        G.Parent = E

        local H = Instance.new'Frame'

        H.Size = UDim2.new(0, 1, 1, 0)
        H.Position = UDim2.new(1, -1, 0, 0)
        H.BackgroundColor3 = e.Colors.Border
        H.BorderSizePixel = 0
        H.Parent = G
        ...
        I.Name = 'NavList'
        I.Size = UDim2.new(1, 0, 1, -65)
        I.BackgroundTransparency = 1
        I.BorderSizePixel = 0
        I.CanvasSize = UDim2.new(0, 0, 0, 0)
        I.AutomaticCanvasSize = Enum.AutomaticSize.Y
        I.ScrollBarThickness = 1
        I.ScrollBarImageColor3 = e.Colors.Border
        I.Parent = G
        ...
        K.PaddingTop = UDim.new(0, 12)
        K.PaddingLeft = UDim.new(0, 12)
        K.PaddingRight = UDim.new(0, 12)
        K.Parent = I
        ...
        local N = q.ToggleKey or Enum.KeyCode.RightControl

        d.InputBegan:Connect(function(O, P)
            if P then
                return
            end
            if O.KeyCode == N then
        ...
        function P.SetProfile(Q, R)
            ...
            O.Name = 'ProfileArea'
            O.Size = UDim2.new(1, 0, 0, 65)
            O.Position = UDim2.new(0, 0, 1, -65)
            O.BackgroundTransparency = 1
            O.Parent = G
            ...
            S.BackgroundColor3 = e.Colors.Border
            S.BorderSizePixel = 0
            S.Parent = O

            local T = Instance.new'Frame'

            T.Size = UDim2.new(1, -20, 1, -1)
            T.Position = UDim2.new(0, 10, 0, 1)
            T.BackgroundTransparency = 1
            T.Parent = O
            ...
            U.Padding = UDim.new(0, 10)
            U.Parent = T

            local V = Instance.new'ImageLabel'

            V.Size = UDim2.fromOffset(36, 36)
            V.BackgroundColor3 = e.Colors.Element
            V.Image = 'rbxthumb://type=AvatarHeadShot&id=' .. tostring(R.UserId or 1) .. '&w=150&h=150'
            V.Parent = T

            local W = Instance.new'UICorner'

            W.CornerRadius = e.CornerRadius.Circle
            W.Parent = V

            local X = Instance.new'UIStroke'

            X.Color = e.Colors.Border
            X.Thickness = 1
            X.Parent = V

            local Y = Instance.new'Frame'

            Y.Size = UDim2.new(1, -46, 0, 36)
            Y.BackgroundTransparency = 1
            Y.Parent = T
            ...
            _.Size = UDim2.new(1, 0, 0, 16)
            _.BackgroundTransparency = 1
            _.Text = R.Username or 'Guest'
            _.TextColor3 = e.Colors.Text
            _.Font = e.Fonts.Bold
            _.TextSize = 12
            ...
            aa.Size = UDim2.new(1, 0, 0, 14)
            aa.BackgroundTransparency = 1
            aa.Text = R.Subtext or 'User'
            aa.TextColor3 = e.Colors.TextSecondary
            aa.Font = e.Fonts.Regular
            aa.TextSize = 10
            aa.TextXAlignment = Enum.TextXAlignment.Left
            aa.TextTruncate = Enum.TextTruncate.AtEnd
            aa.Parent = Y
        end
        function P.Section(aa, Q)
            Q = Q or {}

            if Q.Title and Q.Title ~= '' then
                local R = Instance.new'TextLabel'

                R.Name = 'SecHeader_' .. Q.Title
                R.Size = UDim2.new(1, 0, 0, 18)
                R.BackgroundTransparency = 1
                R.Text = string.upper(Q.Title)
                R.TextColor3 = e.Colors.TextSecondary
                R.Font = e.Fonts.Bold
                R.TextSize = 10
                R.TextXAlignment = Enum.TextXAlignment.Left
                R.Parent = I
            ...
            function R.Tab(S, T)
                ...
                V.CornerRadius = e.CornerRadius.Element
                V.Parent = U

                local W = Instance.new'Frame'

                W.Size = UDim2.new(0, 3, 0, 0)
                W.Position = UDim2.new(0, 4, 0.5, -7)
                W.BackgroundColor3 = e.Colors.Accent
                W.BackgroundTransparency = 1
                W.Parent = U

                local X = Instance.new'UICorner'

                X.CornerRadius = e.CornerRadius.Circle
                X.Parent = W

                local Y = Instance.new'Frame'

                Y.Size = UDim2.new(1, -10, 1, 0)
                Y.Position = UDim2.new(0, 8, 0, 0)
                Y.BackgroundTransparency = 1
                Y.Parent = U
                ...
                if T.Icon then
                    ...
                    _.Size = UDim2.fromOffset(14, 14)
                    _.BackgroundTransparency = 1
                    _.Image = T.Icon
                    _.ImageColor3 = e.Colors.TextSecondary
                    _.Parent = Y
                end

                local _ = Instance.new'TextLabel'

                _.Size = UDim2.new(1, T.Icon and -22 or 0, 1, 0)
                _.BackgroundTransparency = 1
                _.Text = T.Title or 'Tab'
                _.TextColor3 = e.Colors.TextSecondary
                _.Font = e.Fonts.Medium
                _.TextSize = 12
                _.TextXAlignment = Enum.TextXAlignment.Left
                _.Parent = Y
                ...
                ab.ScrollBarThickness = 4
                ab.ScrollBarImageColor3 = e.Colors.Border
                ab.CanvasSize = UDim2.new(0, 0, 0, 0)
                ab.AutomaticCanvasSize = Enum.AutomaticSize.Y
                ab.Visible = false
                ab.Parent = L

                local ac = Instance.new'UIListLayout'

                ac.Padding = UDim.new(0, 12)
                ac.Parent = ab

                local ad = Instance.new'UIPadding'

                ad.PaddingTop = UDim.new(0, 12)
                ad.PaddingBottom = UDim.new(0, 15)
                ad.PaddingLeft = UDim.new(0, 12)
                ad.PaddingRight = UDim.new(0, 12)
                ad.Parent = ab
                ...
                local function selectTab()
                    ...
                    if m then
                        m.BackgroundTransparency = 1
                        m.ActiveBar.Size = UDim2.new(0, 3, 0, 0)
                        m.ActiveBar.BackgroundTransparency = 1
                        m.Content.Label.TextColor3 = e.Colors.TextSecondary
                        m.Content.Label.Font = e.Fonts.Medium

                        if m.Content:FindFirstChild'Icon' then
                            m.Content.Icon.ImageColor3 = e.Colors.TextSecondary
                        end
                    end
                    ...
                    m = U
                    ab.Visible = true
                    U.BackgroundColor3 = e.Colors.Element
                    U.BackgroundTransparency = 0
                    W.Size = UDim2.new(0, 3, 0, 14)
                    W.BackgroundTransparency = 0
                    _.TextColor3 = e.Colors.Text
                    _.Font = e.Fonts.Bold

                    if Y:FindFirstChild'Icon' then
                        Y.Icon.ImageColor3 = e.Colors.Text
                    end
                end

                U.MouseButton1Click:Connect(selectTab)
                ...
                function ae.SetBanner(af, ag)
                    local ah = Instance.new'Frame'

                    ah.Size = UDim2.new(1, 0, 0, 80)
                    ah.BackgroundColor3 = e.Colors.Card
                    ah.Parent = ab

                    local ai = Instance.new'UICorner'

                    ai.CornerRadius = e.CornerRadius.Card
                    ai.Parent = ah

                    local aj = Instance.new'UIStroke'

                    aj.Color = e.Colors.Border
                    aj.Thickness = 1
                    aj.Parent = ah
                    ...
                    ak.Padding = UDim.new(0, 15)
                    ak.Parent = ah

                    local al = Instance.new'UIPadding'

                    al.PaddingLeft = UDim.new(0, 15)
                    al.PaddingRight = UDim.new(0, 15)
                    al.Parent = ah

                    local am = Instance.new'ImageLabel'

                    am.Size = UDim2.fromOffset(48, 48)
                    am.BackgroundColor3 = e.Colors.Element
                    am.Image = 'rbxthumb://type=AvatarHeadShot&id=' .. tostring(ag.UserId or 1) .. '&w=150&h=150'
                    am.Parent = ah

                    local an = Instance.new'UICorner'

                    an.CornerRadius = e.CornerRadius.Circle
                    an.Parent = am

                    local ao = Instance.new'UIStroke'

                    ao.Color = e.Colors.Border
                    ao.Thickness = 1
                    ao.Parent = am

                    local ap = Instance.new'Frame'

                    ap.Size = UDim2.new(1, -63, 0, 40)
                    ap.BackgroundTransparency = 1
                    ap.Parent = ah

                    local aq = Instance.new'UIListLayout'

                    aq.FillDirection = Enum.FillDirection.Vertical
                    aq.VerticalAlignment = Enum.VerticalAlignment.Center
                    aq.Padding = UDim.new(0, 2)
                    aq.Parent = ap
                    ...
                    ar.Text = 'Hello, ' .. (ag.Username or 'Guest')
                    ar.TextColor3 = e.Colors.Text
                    ar.Font = e.Fonts.Bold
                    ar.TextSize = 16
                    ...
                    as.Size = UDim2.new(1, 0, 0, 16)
                    as.BackgroundTransparency = 1
                    as.Text = ag.Subtext or ''
                    as.TextColor3 = e.Colors.TextSecondary
                    as.Font = e.Fonts.Regular
                    as.TextSize = 12
                    as.TextXAlignment = Enum.TextXAlignment.Left
                    as.Parent = ap
                end
                function ae.PageSection(af, ag)
                    ag = ag or {}

                    local ah = Instance.new'Frame'

                    ah.Size = UDim2.new(1, 0, 0, 0)
                    ...
                    ak.PaddingTop = UDim.new(0, 14)
                    ak.PaddingBottom = UDim.new(0, 14)
                    ak.PaddingLeft = UDim.new(0, 14)
                    ak.PaddingRight = UDim.new(0, 14)
                    ak.Parent = ah
                    ...
                    am.Padding = UDim.new(0, 10)
                    am.Parent = al

                    if ag.Title or ag.Subtitle then
                        ...
                        ao.Padding = UDim.new(0, 2)
                        ao.Parent = an

                        if ag.Title then
                            local ap = Instance.new'TextLabel'

                            ap.Size = UDim2.new(1, 0, 0, 18)
                            ap.BackgroundTransparency = 1
                            ap.Text = ag.Title
                            ap.TextColor3 = e.Colors.Text
                            ap.Font = e.Fonts.Bold
                            ap.TextSize = 15
                        ...
                        if ag.Subtitle then
                            ...
                            ap.Size = UDim2.new(1, 0, 0, 14)
                            ap.BackgroundTransparency = 1
                            ap.Text = ag.Subtitle
                            ap.TextColor3 = e.Colors.TextSecondary
                            ap.Font = e.Fonts.Regular
                            ap.TextSize = 11
                            ap.TextXAlignment = Enum.TextXAlignment.Left
                            ap.Parent = an
                        end
                        ...
                        ap.BackgroundColor3 = e.Colors.Border
                    ...
                    function an.Form(ao)
                        ...
                        ap.Size = UDim2.new(1, 0, 0, 0)
                        ap.AutomaticSize = Enum.AutomaticSize.Y
                        ap.BackgroundTransparency = 1
                        ap.Parent = al
                        ...
                        setupContainerMethods(ar, ap, T.Title)
                ...
                function ae.Form(af)
                    ...
                    ah.Padding = UDim.new(0, 8)
                    ah.Parent = ag

                    local ai = {}

                    setupContainerMethods(ai, ag, T.Title)

                    return ai
                end
                function ae.Tab(af, ag)
                    ag = ag or {}
                    ag.parentTabId = T.Title
    ...
    function h.Notification(aa, ab)
        ab = ab or {}

        local ac = ab.Title or 'Notification'
        local ad = ab.Subtitle or ''
        local ae = ab.AppIcon or ab.Icon or 'rbxassetid://10747373111'
        local af = ab.Duration or 5
        ...
        ag.Size = UDim2.new(1, 0, 0, 60)
        ag.BackgroundColor3 = e.Colors.Card
        ag.Parent = n

        local ah = Instance.new'UICorner'

        ah.CornerRadius = e.CornerRadius.Card
        ah.Parent = ag

        local ai = Instance.new'UIStroke'

        ai.Color = e.Colors.Border
        ai.Thickness = 1
        ai.Parent = ag

        local aj = Instance.new'UIPadding'

        aj.PaddingTop = UDim.new(0, 10)
        aj.PaddingBottom = UDim.new(0, 10)
        aj.PaddingLeft = UDim.new(0, 12)
        aj.PaddingRight = UDim.new(0, 12)
        aj.Parent = ag
        ...
        ak.FillDirection = Enum.FillDirection.Horizontal
        ak.VerticalAlignment = Enum.VerticalAlignment.Center
        ak.Padding = UDim.new(0, 10)
        ak.Parent = ag

        local al = Instance.new'ImageLabel'

        al.Size = UDim2.fromOffset(24, 24)
        al.BackgroundTransparency = 1
        al.Image = ae
        al.ImageColor3 = e.Colors.Accent
        al.Parent = ag

        local am = Instance.new'Frame'

        am.Size = UDim2.new(1, -34, 1, 0)
        am.BackgroundTransparency = 1
        am.Parent = ag

        local an = Instance.new'UIListLayout'

        an.FillDirection = Enum.FillDirection.Vertical
        ...
        ao.Text = ac
        ao.TextColor3 = e.Colors.Text
        ao.Font = e.Fonts.Bold
        ao.TextSize = 12
        ...
        ap.TextSize = 10
        ap.TextXAlignment = Enum.TextXAlignment.Left
        ap.TextTruncate = Enum.TextTruncate.AtEnd
        ap.Parent = am
        ag.Position = UDim2.new(1, 50, 0, 0)
        ag.BackgroundTransparency = 1
        ...
        c:Create(ag, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
            Position = UDim2.new(0, 0, 0, 0),
            BackgroundTransparency = 0,
        }):Play()
        c:Create(al, TweenInfo.new(0.4), {ImageTransparency = 0}):Play()
        c:Create(ao, TweenInfo.new(0.4), {TextTransparency = 0}):Play()
        c:Create(ap, TweenInfo.new(0.4), {TextTransparency = 0}):Play()
        c:Create(ai, TweenInfo.new(0.4), {Transparency = 0}):Play()
        task.spawn(function()
            task.wait(af)

            local aq = c:Create(ag, TweenInfo.new(0.3), {
                Position = UDim2.new(1, 50, 0, 0),
                BackgroundTransparency = 1,
            })

            c:Create(al, TweenInfo.new(0.3), {ImageTransparency = 1}):Play()
            c:Create(ao, TweenInfo.new(0.3), {TextTransparency = 1}):Play()
            c:Create(ap, TweenInfo.new(0.3), {TextTransparency = 1}):Play()
            c:Create(ai, TweenInfo.new(0.3), {Transparency = 1}):Play()
            aq:Play()
