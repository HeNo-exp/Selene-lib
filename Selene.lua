    ...
    self.unsubscribeStore = self.props.Store:Subscribe(function(newState)
        ...
        if containerObj then
            ...
            if not isMin then
                ...
                local sidebarEl = React.createElement(Sidebar, { state = newState, Store = self.props.Store })
                local tabContainerEl = React.createElement(TabContainer, { state = newState, Store = self.props.Store })
