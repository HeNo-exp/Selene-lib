...
local IconsObj = __require("Icons")
    ...
    return React.createElement("TextButton", {
        ...
        Content = React.createElement("Frame", {
            ...
            Icon = tab.icon and React.createElement("ImageLabel", {
                ...
                Size = UDim2.new(0, 14, 0, 14),
                BackgroundTransparency = 1,
                Image = IconsObj.assets[tab.icon] or IconsObj.assets["lucide-" .. tostring(tab.icon)] or tab.icon,
...
function Library:CreateWindow(config)
    ...
    if not root then
        ...
        Store:Subscribe(function(newState)
            ...
            for k, v in pairs(activeTheme or {}) do
                Theme.Colors[k] = v
            end
