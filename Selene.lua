...
a["Components_BarChart"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")

local Source = (script and typeof(script) == "Instance" and script.Parent) and script.Parent.Parent or {}
...
a["Components_ColorPicker"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_ColorPickerDialog"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_ColorPickerWidget"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
function ColorPickerWidget:render()
    ...
    return React.createElement("Frame", {
        ...
        -- Red Slider
        Red = React.createElement(__require("Components_Slider"), {
            Store = Store,
            element = {
                name = "Red",
                min = 0,
        ...
        -- Green Slider
        Green = React.createElement(__require("Components_Slider"), {
            Store = Store,
            element = {
                name = "Green",
                min = 0,
        ...
        -- Blue Slider
        Blue = React.createElement(__require("Components_Slider"), {
            Store = Store,
            element = {
                name = "Blue",
                min = 0,
        ...
        -- Transparency Slider
        Transparency = React.createElement(__require("Components_Slider"), {
            Store = Store,
            element = {
                name = "Transparency",
                min = 0,
...
a["Components_Dropdown"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_ElementRenderer"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
function ElementRenderer.render(el, Store)
    ...
    if elType == "Button" then
        return React.createElement(__require("Components_Button"), { element = el, Store = Store })
    elseif elType == "Toggle" then
        return React.createElement(__require("Components_Toggle"), { element = el, Store = Store })
    elseif elType == "Slider" then
        return React.createElement(__require("Components_Slider"), { element = el, Store = Store })
    elseif elType == "Dropdown" then
        return React.createElement(__require("Components_Dropdown"), { element = el, Store = Store })
    elseif elType == "TextBox" then
        return React.createElement(__require("Components_TextBox"), { element = el, Store = Store })
    elseif elType == "Label" then
        return React.createElement(__require("Components_Label"), { element = el, Store = Store })
    elseif elType == "Paragraph" then
        return React.createElement(__require("Components_Paragraph"), { element = el, Store = Store })
    elseif elType == "InfoGrid" then
        return React.createElement(__require("Components_InfoGrid"), { element = el, Store = Store })
    elseif elType == "VStack" then
        return React.createElement(__require("Components_VStack"), { element = el, Store = Store })
    elseif elType == "HStack" then
        return React.createElement(__require("Components_HStack"), { element = el, Store = Store })
    elseif elType == "ColorPicker" then
        return React.createElement(__require("Components_ColorPicker"), { element = el, Store = Store })
    elseif elType == "ColorPickerWidget" then
        return React.createElement(__require("Components_ColorPickerWidget"), { element = el, Store = Store })
    elseif elType == "KeybindField" then
        return React.createElement(__require("Components_KeybindField"), { element = el, Store = Store })
    elseif elType == "Stepper" then
        return React.createElement(__require("Components_Stepper"), { element = el, Store = Store })
    elseif elType == "RadioButtonGroup" then
        return React.createElement(__require("Components_RadioButtonGroup"), { element = el, Store = Store })
    elseif elType == "BarChart" then
        return React.createElement(__require("Components_BarChart"), { element = el, Store = Store })
    elseif elType == "LineChart" then
        return React.createElement(__require("Components_LineChart"), { element = el, Store = Store })
    elseif elType == "PieChart" then
        return React.createElement(__require("Components_PieChart"), { element = el, Store = Store })
    elseif elType == "PullDownButton" then
        return React.createElement(__require("Components_PullDownButton"), { element = el, Store = Store })
    elseif elType == "TitleStack" then
        return React.createElement(__require("Components_TitleStack"), { element = el, Store = Store })
    elseif elType == "Row" then
        return React.createElement(__require("Components_Row"), { element = el, Store = Store })
    elseif elType == "Form" then
        return React.createElement(__require("Components_Form"), { element = el, Store = Store })
    elseif elType == "Section" then
        return React.createElement(__require("Components_Section"), { section = el, Store = Store })
...
a["Components_Form"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")

local Source = (script and typeof(script) == "Instance" and script.Parent) and script.Parent.Parent or {}
local ElementRenderer = __require("Components_ElementRenderer")
...
a["Components_InfoGrid"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_KeybindField"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local UserInputService = game:GetService("UserInputService")
local React = __require("React")
...
a["Components_LineChart"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_Notification"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local React = __require("React")
...
a["Components_Paragraph"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_PieChart"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local React = __require("React")
...
a["Components_PullDownButton"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local React = __require("React")
...
a["Components_RadioButtonGroup"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
a["Components_TabContainer"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local TweenService = game:GetService("TweenService")
local React = __require("React")
...
local Section = __require("Components_Section")
local ProfileComponent = __require("Components_Profile")
...
a["Components_TitleStack"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
...
local Source = (script and typeof(script) == "Instance" and script.Parent) and script.Parent.Parent or {}
local Theme = __require("Theme")
local Sidebar = __require("Components_Sidebar")
local TabContainer = __require("Components_TabContainer")
...
function Window:render()
    ...
    return React.createElement("CanvasGroup", {
        ...
        ColorPickerOverlay = state.colorPickerActive and React.createElement(__require("Components_ColorPickerDialog"), {
...
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local React = __require("React")
local ReactRoblox = __require("ReactRoblox")

local Theme = __require("Theme")
local Store = __require("Store")
local AppRecorderObj = __require("AppRecorder")
...
function Library:CreateWindow(config)
    ...
    if not root then
        local function App()
            ...
            local Source = (script and typeof(script) == "Instance") and script or {}
            local WindowComponent = __require("Components_Window")
            local NotificationComponent = __require("Components_Notification")
    ...
    function Window:AddTab(tabConfig)
        if not self._defaultSection then
            self._defaultSection = self:Section({ Title = "" })
        end
        return self._defaultSection:Tab(tabConfig)
    end
